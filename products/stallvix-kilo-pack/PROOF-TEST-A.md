...
All of A1–A6 PASS **in a real Kilo session**. Only then may write-capable `stallvix-implementer` jobs be attempted on **allowed paths only** (still gated by KILO-01 / KILO-02 in the command center).
